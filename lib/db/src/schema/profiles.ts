...
export const profilesTable = pgTable("profiles", {
  ...
  defaultPetrolPrice: numeric("default_petrol_price", { precision: 6, scale: 3 }),
  defaultDieselPrice: numeric("default_diesel_price", { precision: 6, scale: 3 }),
  defaultLpgPrice: numeric("default_lpg_price", { precision: 6, scale: 3 }),
